...
public:
	 ...
	 * that the stack was put to the screen with the intention of adding additional stack later on with the linking
	 * functions below.
	 */
...
private:
	// This flag is used to verify if the linked stack was created correctly with StartNewLinkedStack() or one of the
