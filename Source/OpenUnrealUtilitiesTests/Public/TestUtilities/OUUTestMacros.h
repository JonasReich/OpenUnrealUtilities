...
#define SPEC_TEST_INVALID(Actual) TestInvalid(PREPROCESSOR_TO_STRING(Actual), Actual, Actual)
#define SPEC_TEST_NULL(Actual) TestNull(PREPROCESSOR_TO_STRING(Actual), Actual, Actual)
#define SPEC_TEST_NOT_NULL(Actual) TestNotNull(PREPROCESSOR_TO_STRING(Actual), Actual, Actual)
#define SPEC_TEST_NOT_NULL(Actual) TestNotNull(PREPROCESSOR_TO_STRING(Actual), Actual, Actual)
