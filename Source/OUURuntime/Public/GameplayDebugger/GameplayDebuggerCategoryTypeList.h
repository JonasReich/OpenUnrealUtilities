...
namespace GameplayDebuggerCategoryConcepts
{
	...
	struct CHasExplicitInstanceMethod
	{
		template <typename T>
		auto Requires() -> decltype(
			TSharedRef<FGameplayDebuggerCategory>(T::MakeInstance())
		);
	};
}
...
{
public:
	static_assert(TIsDerivedFrom<GameplayDebuggerCategoryType, FGameplayDebuggerCategory>::Value,
		"GameplayDebuggerCategoryType must be derived from FGameplayDebuggerCategory");
	static_assert(TModels<GameplayDebuggerCategoryConcepts::CHasCategoryName, GameplayDebuggerCategoryType>::Value,
	...
	static constexpr auto GetCategoryName()
	{
		return GameplayDebuggerCategoryType::GetCategoryName();
	}
...
public:
	...
	static void RegisterCategories(IGameplayDebugger& GameplayDebugger)
	{
		GameplayDebugger.RegisterCategory(
			...
			IGameplayDebugger::FOnGetCategory::CreateStatic(TGameplayDebuggerCategoryTraits<DebuggerCategoryType>::MakeInstance),
			InitialState);
	}
