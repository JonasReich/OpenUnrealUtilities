 ...
 * Because UE4 uses a left handed coordinate system you will have to use LeftHanded when using the utilities below with UE4 coordinates
 */
UENUM(BlueprintType)
...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure)
	static int32 ConvertWorldLocation2DToSpiralId(const FVector2D& Location, float GridSize, ESpiralCoordinateSystemType CoordinateSystem);
	 ...
	 */
	UFUNCTION(BlueprintPure)
	static int32 ConvertWorldLocationToSpiralId(const FVector& Location, float GridSize, ESpiralCoordinateSystemType CoordinateSystem);
	 ...
	 */
	UFUNCTION(BlueprintPure)
	static FVector2D ConvertSpiralIdToCenterLocation(const int32 SpiralId, float GridSize, ESpiralCoordinateSystemType CoordinateSystem);
	 ...
	 */
	UFUNCTION(BlueprintPure)
	static FBox2D ConvertSpiralIdToBounds(const int32 SpiralId, const float GridSize, ESpiralCoordinateSystemType CoordinateSystem);
	 ...
	 */
	UFUNCTION(BlueprintPure)
	static FBox ConvertSpiralIdToBounds3D(const int32 SpiralId, const float GridSize, ESpiralCoordinateSystemType CoordinateSystem, const float BoundsHeight, const float BoundsElevation);
};
