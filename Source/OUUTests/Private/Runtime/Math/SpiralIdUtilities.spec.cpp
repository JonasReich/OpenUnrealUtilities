...
const TMap<int32, FVector2D> SampleBounds =
	{{0, {7500, -7500}}, {1, {7500, 7500}}, {107, {37500, -82500}}, {130, {-52500, 82500}}, {237, {-67500, 112500}}};
...
void FSpiralIdUtilitiesSpec::Define()
{
	...
	It("ConvertWorldLocation2DToSpiralId / ConvertSpiralIdToCenterLocation should "
	   "convert parcel IDs to/from cell center locations as expected",
	   [this]() {
		   for (auto& Entry : SampleBounds)
		   {
			   ...
			   const FVector2D ResultLocation = USpiralIdUtilities::ConvertSpiralIdToCenterLocation(
				   ExpectedSpiralId,
				   GridSize,
				   ESpiralCoordinateSystemType::LeftHanded);
			   const int32 ResultSpiralId = USpiralIdUtilities::ConvertWorldLocation2DToSpiralId(
				   ExpectedLocation,
				   GridSize,
				   ESpiralCoordinateSystemType::LeftHanded);
