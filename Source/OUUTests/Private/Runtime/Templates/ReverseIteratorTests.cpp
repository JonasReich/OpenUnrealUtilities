...
static_assert(
	TModels<CMemberToStringConvertable, ReverseIteratorTests::FFoo>::Value,
	"Sanity check: FFoo has ToString() member");
static_assert(
	TModels<CLexToStringConvertible, ReverseIteratorTests::FFoo>::Value,
...
OUU_IMPLEMENT_SIMPLE_AUTOMATION_TEST(TArray_Int, DEFAULT_OUU_TEST_FLAGS)
{
	...
	ReverseIteratorTests::TestReverseIterator<TArray<int32>, int32>(
		*this,
		OriginArray,
		{5, 4, 3, 2, 1},
		"TArray<int32>");
	ReverseIteratorTests::TestConstReverseIterator<TArray<int32>, int32>(
		*this,
		OriginArray,
		{5, 4, 3, 2, 1},
		"TArray<int32>");
...
OUU_IMPLEMENT_SIMPLE_AUTOMATION_TEST(TArray_FFoo, DEFAULT_OUU_TEST_FLAGS)
{
	...
	ReverseIteratorTests::TestConstReverseIterator<TArray<FFoo>, FFoo>(
		*this,
		OriginArray,
		{5, 4, 3, 2, 1},
		"TArray<FFoo>");
