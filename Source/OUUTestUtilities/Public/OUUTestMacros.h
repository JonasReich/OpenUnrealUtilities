 ...
 * other flags.
 */
constexpr EAutomationTestFlags DEFAULT_OUU_TEST_FLAGS =
...
FORCEINLINE FString OUUTESTUTILITIES_API EscapeTestName(const FString& InTestName)
{
	...
	/**
	 * Use this macro in conjunction with a predefined OUU_TEST_CATEGORY and OUU_TEST_TYPE to declare a simple
	 * automation test. Used like this:
	 * -------------------------
	...
	#define OUU_IMPLEMENT_SIMPLE_AUTOMATION_TEST(TestCase, TestFlags)                                                  \
		OUU_IMPLEMENT_SIMPLE_AUTOMATION_TEST_INNER(                                                                    \
			OUU_TEST_CLASS(TestCase),                                                                                  \
			OUU_TESTCASE_PRETTY_NAME(TestCase),                                                                        \
			TestFlags)

	/**
	 * Use this macro in conjunction with a predefined OUU_TEST_CATEGORY and OUU_TEST_TYPE to declare a complex
	 * automation test. In contrast to simple tests, complex automation tests are called on multiple test-cases based on
	 * strings. This utility allows declaring those test-cases in a simple list instead of manually implementing the
	 * GetTests() function of the test class. Used like this:
	 * -------------------------
	...
	#define OUU_IMPLEMENT_COMPLEX_AUTOMATION_TEST_BEGIN(TestCase, TestFlags)                                           \
		OUU_IMPLEMENT_COMPLEX_AUTOMATION_TEST_BEGIN_INNER(                                                             \
			OUU_TEST_CLASS(TestCase),                                                                                  \
			OUU_TESTCASE_PRETTY_NAME(TestCase),                                                                        \
			TestFlags)
	 ...
	 */
	#define OUU_COMPLEX_AUTOMATION_TESTCASE(TestCaseString) OUU_COMPLEX_AUTOMATION_TESTCASE_INNER(TestCaseString)
