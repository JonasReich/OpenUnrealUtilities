...
struct OPENUNREALUTILITIES_API FRegexMatch
{
	GENERATED_BODY()
public:
	FRegexMatch() = default;
...
USTRUCT(BlueprintType)
struct OPENUNREALUTILITIES_API FRegexGroups
{
	GENERATED_BODY()
public:
...
UCLASS()
class OPENUNREALUTILITIES_API URegexFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
